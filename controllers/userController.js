                          ...
                          <tr>
                            <td class="bg_white email-section">
                                <div class="heading-section" style="text-align: center; padding: 0 30px;">
                                  <h2>Activation URL<br>http://localhost:3003/active?id_user=${req.user.id}&activeID=${randomID}</h2>
                ...
                <div style="max-width: 600px; margin: 0 auto;" class="email-container">
                  ...
                  <table align="center" role="presentation" cellspacing="0" cellpadding="0" width="100%" style="margin: auto;">
                      ...
                      <tr>
                        <td class="bg_white email-section">
                            <div class="heading-section" style="text-align: center; padding: 0 30px;">
                              <h2>Activation URL<br>http://localhost:3003/active?id_user=${user._id}&activeID=${randomID}</h2>
                              <p style="font-size: 20px;">Thank you for using our service.</p>
                            </div>
                      </td>
                    </tr><!-- end: tr -->
